...
func GetConfig(configFile string, codeCommit CodeRepo) model.Config {
...
func PutConfig(codeCommit CodeRepo, config model.Config) {
...
func GetRemoteConfig(codeCommit CodeRepo) model.Config {
