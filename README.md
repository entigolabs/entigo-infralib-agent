...
* location - location used when creating gcloud/azure resources [$LOCATION]
* subscription-id - subscription id used when creating azure resources [$SUBSCRIPTION_ID]
* resource-group - resource group used when creating azure resources [$RESOURCE_GROUP]
* azure-devops-org - azure devops organization name, used when creating azure pipelines [$AZURE_DEVOPS_ORG]
* azure-devops-project - azure devops project name, used when creating azure pipelines [$AZURE_DEVOPS_PROJECT]
